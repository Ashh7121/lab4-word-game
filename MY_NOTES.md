...
Display the word as blank spaces
Number of wrong guesses allowed variable, max 6
Another list to keep guesses letters
Decrement attempts for every wrong guess
Use join method to make the output look cleaner; display the word without it being in an array format

Treid to ask copilot to criticise the code but it keeps asking me questions and I am not sure how to work with copilot for now
